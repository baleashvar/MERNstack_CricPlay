...
class PlayersInsert extends Component {
    ...
    handleSubmitPlayer = async(event) => {
        ...
        const payload = { name, age, batting, bowling, fielding, wk, highestscore, bestbowlfig }

        event.preventDefault();     //Most important
        
        // alert(JSON.stringify(payload))
        alert('Creating Player. Please wait.')

        await api.insertPlayer(payload)
            .then(res => {
                alert(`Player inserted successfully with details\n` + JSON.stringify(payload))
                this.setState({
                    name: '',
                    age: '',
                    batting: '',
                        ...
                        <Form onSubmit={this.handleSubmitPlayer}>
                            ...
                            <FormGroup>
                                ...
                                <Input type="number" id="batting" name="batting"
                                    ...
                                    onChange={this.handleInputChange}
                                    required
                                    // innerRef={(input => this.batting = input)} 
                                />
                                <FormFeedback>
                                    {errors.batting}
                                </FormFeedback>
                            ...
                            <FormGroup>
                                ...
                                <Input type="number" id="bowling" name="bowling"
                                    ...
                                    onChange={this.handleInputChange}
                                    required
                                    // innerRef={(input => this.bowling = input)} 
                                />
                                <FormFeedback>
                                    {errors.bowling}
                                </FormFeedback>
                            ...
                            <FormGroup>
                                ...
                                <Input type="number" id="fielding" name="fielding"
                                    ...
                                    onChange={this.handleInputChange}
                                    required
                                    // innerRef={(input => this.fielding = input)} 
                                />
                                <FormFeedback>
                                    {errors.fielding}
                                </FormFeedback>
                            ...
                            <FormGroup>
                                ...
                                <Input type="number" id="highestscore" name="highestscore"
                                    ...
                                    onChange={this.handleInputChange}
                                    required
                                    // innerRef={(input => this.highestscore = input)} 
                                />
                                <FormFeedback>
                                    {errors.highestscore}
                                </FormFeedback>
                            ...
                            <FormGroup>
                                ...
                                <Input type="text" id="bestbowlfig" name="bestbowlfig"
                                    ...
                                    onChange={this.handleInputChange}
                                    required
                                    // innerRef={(input => this.bestbowlfig = input)} 
                                />
                                <FormFeedback>
                                    {errors.bestbowlfig}
                                </FormFeedback>
                            ...
                            <FormGroup check>
                                <Label check>
                                    <Input type="checkbox" name="wk" 
                                        ...
                                        onChange={this.handleInputChange}
                                        // innerRef={(input => this.wk = input)} 
                                    />
                                    Does he keep wickets?
                                </Label>
                            </FormGroup>
                            <FormGroup>
                                <Button type="submit" value="submit" id="createbutton" color="primary">Create Player</Button>
